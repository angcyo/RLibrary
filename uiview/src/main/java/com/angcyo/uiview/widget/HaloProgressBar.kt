...
class HaloProgressBar(context: Context, attributeSet: AttributeSet? = null) : View(context, attributeSet) {
    ...
    /**光晕圆圈颜色*/
    var circleHaloColor = SkinHelper.getTranColor(Color.WHITE, 0x30)
    ...
    private val animatorFinish by lazy {
        ObjectAnimator.ofFloat(circleInnerRadius, ClipHelper.c((measuredWidth / 2).toFloat(), (measuredHeight / 2).toFloat())).apply {
            duration = 300
            addUpdateListener {
