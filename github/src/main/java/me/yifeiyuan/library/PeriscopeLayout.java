...
public class PeriscopeLayout extends FrameLayout {
    ...
    private void init() {
        ...
        lp.gravity = Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL;//(CENTER_HORIZONTAL, TRUE);//这里的TRUE 要注意 不是true
    ...
    public void addHeart() {
        addHeart((mWidth - dWidth) / 2);
    }

    public void addHeart(int startX) {
    ...
    private PointF getPointF(int scale) {
        ...
        pointF.y = random.nextInt((mHeight - 100)) * 1f / scale;
        return pointF;
    }
