package com.angcyo.github.pickerview.lib;
...
import com.angcyo.github.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public static final float DEFAULT_SPACE_MULTIPLIER = 1.4F;
    // 修改这个值可以改变滑行速度
