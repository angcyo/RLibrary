package com.angcyo.github.pickerview.view;

import android.view.Gravity;
import android.view.View;

import com.angcyo.github.R;
import com.angcyo.github.pickerview.adapter.NumericWheelAdapter;
...
import static com.angcyo.github.pickerview.lib.WheelView.DEFAULT_SPACE_MULTIPLIER;
...
public class WheelTime {
    ...
    int dividerColor;
    // 条目间距倍数
    float lineSpacingMultiplier = DEFAULT_SPACE_MULTIPLIER;
    private View view;
    ...
    public WheelTime(View view, boolean[] type) {
        this(view, type, Gravity.CENTER, 16);
    }
