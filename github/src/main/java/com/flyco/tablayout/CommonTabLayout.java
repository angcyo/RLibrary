...
import com.flyco.tablayout.listener.SimpleTabSelectListener;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mCurrentTab = -1;//angcyo
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setCurrentTab(int currentTab, boolean notify) {
        ...
        mLastTab = this.mCurrentTab == -1 ? 0 : this.mCurrentTab;//angcyo
    ...
    /**
     * angcyo 请在{@link #setTabData(ArrayList, FragmentActivity, int, ArrayList)}
     * 之前调用
     */
