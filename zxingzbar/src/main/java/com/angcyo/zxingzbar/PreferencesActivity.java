...
public final class PreferencesActivity {
    public static final String KEY_DECODER_TYPE = "preferences_decoder";                  //解码器类型
    public static final String KEY_SCANNING_CATEGORY = "preferences_scanning_category";   //条码类型设置
